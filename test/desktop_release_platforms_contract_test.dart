...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1161+205'));
    expect(config, contains("defaultValue: '1.0.1161'"));
    expect(androidGradle, contains('versionCode = 205'));
    expect(androidGradle, contains('versionName = "1.0.1161"'));
