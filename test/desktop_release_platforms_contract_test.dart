...
void main() {
  ...
  test('desktop platform metadata stays versioned and documented', () {
    ...
    expect(pubspec, contains('version: 1.0.1158+202'));
    expect(config, contains("defaultValue: '1.0.1158'"));
    expect(androidGradle, contains('versionCode = 202'));
    expect(androidGradle, contains('versionName = "1.0.1158"'));
